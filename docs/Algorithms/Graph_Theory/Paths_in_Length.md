...
It remains to note that the matrix products can be raised to a high power efficiently using [Binary exponentiation](/docs/#Algorithms/algebra/binary-exp/).
...
It remains to note that we also can compute this exponentiation efficiently with [Binary exponentiation](/docs/#Algorithms/algebra/binary-exp/), because the modified multiplication is obviously associative.
