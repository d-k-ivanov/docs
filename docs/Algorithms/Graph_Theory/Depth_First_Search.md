...
These classifications are often used for problems like [finding bridges](/docs/#Algorithms/Graph_Theory/Bridge_Searching/) and [finding articulation points](/docs/#Algorithms/Graph_Theory/Cut_Points/).
