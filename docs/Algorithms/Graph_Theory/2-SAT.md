...
<center>!["Implication Graph of 2-SAT example"](/docs/data/cs/2SAT.png)</center>
...
<center>!["Strongly Connected Components of the 2-SAT example"](/docs/data/cs/2SAT_SCC.png)</center>
