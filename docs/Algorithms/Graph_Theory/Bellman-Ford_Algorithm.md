...
For more on this topic — see separate article, [Finding a negative cycle in the graph](/docs/#Algorithms/Graph_Theory/Cycle_Negative/).
...
See also the problem list in the article [Finding the negative cycle in a graph](/docs/#Algorithms/Graph_Theory/Cycle_Negative).
