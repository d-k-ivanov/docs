...
There is already the article [Finding Bridges in $O(N+M)$](/docs/#Algorithms/Graph_Theory/Bridge_Searching/) which solves this task with a [Depth First Search](/docs/#Algorithms/Graph_Theory/Depth_First_Search/) traversal.
...
* Searching for the cycle formed by adding a new edge $(a, b)$.
  Since $a$ and $b$ are already connected in the tree we need to find the [Lowest Common Ancestor](/docs/#Algorithms/Graph_Theory/Lowest_Common_Ancestor/) of the vertices $a$ and $b$.
