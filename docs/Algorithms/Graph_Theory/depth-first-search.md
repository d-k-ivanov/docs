...
These classifications are often used for problems like [finding bridges](/docs/#Algorithms/graph/bridge-searching/) and [finding articulation points](/docs/#Algorithms/graph/cutpoints/).
