...
current point belongs to the upper set S1. Checking for clockwise or anticlockwise nature can be done by checking the [orientation](/docs/#Algorithms/geometry/oriented-triangle-area/).
