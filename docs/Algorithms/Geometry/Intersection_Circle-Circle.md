...
Let's reduce this problem to the [circle-line intersection problem](/docs/#Algorithms/Geometry/Intersection_Circle-Line/).
...
And this problem can be solved as described in the [corresponding article](/docs/#Algorithms/Geometry/Intersection_Circle-Line/).
