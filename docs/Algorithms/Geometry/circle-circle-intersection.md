...
Let's reduce this problem to the [circle-line intersection problem](/docs/#Algorithms/geometry/circle-line-intersection/).
...
And this problem can be solved as described in the [corresponding article](/docs/#Algorithms/geometry/circle-line-intersection/).
