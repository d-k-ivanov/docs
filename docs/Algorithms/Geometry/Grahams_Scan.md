...
current point belongs to the upper set S1. Checking for clockwise or anticlockwise nature can be done by checking the [orientation](/docs/#Algorithms/Geometry/Oriented_Triangle_Area/).
