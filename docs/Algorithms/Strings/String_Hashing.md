...
Therefore we need to find the [modular multiplicative inverse](/docs/#Algorithms/Algebra/Modular_Multiplicative_Inverse/) of $p^i$ and then perform multiplication with this inverse.
...
* [Rabin-Karp algorithm](/docs/#Algorithms/String/String_Matching_Rabin-Karp/) for pattern matching in a string in $O(n)$ time
