...
Therefore we need to find the [modular multiplicative inverse](/docs/#Algorithms/algebra/module-inverse/) of $p^i$ and then perform multiplication with this inverse.
...
* [Rabin-Karp algorithm](/docs/#Algorithms/string/rabin-karp/) for pattern matching in a string in $O(n)$ time
