...
Additionally it is also possible to apply more complex operations and answer more complex queries (see [Advanced versions of Segment Trees](/docs/#Algorithms/Data_Structures/Segment_Tree/#advanced-versions-of-segment-trees)).
...
!["Sum Segment Tree"](/docs/data/cs/sum-segment-tree.png)
...
!["Sum Segment Tree Query"](/docs/data/cs/sum-segment-tree-query.png)
...
!["Sum Segment Tree Update"](/docs/data/cs/sum-segment-tree-update.png)
...
other Segment Trees (somewhat discussed in [Generalization to higher dimensions](/docs/#Algorithms/Data_Structures/Segment_Tree/#generalization-to-higher-dimensions)), Fenwick Trees, Cartesian trees, etc.
...
In conclusion we note that the two-dimensional Segment Tree contracted in the described way becomes practically equivalent to the modification of the one-dimensional Segment Tree (see [Saving the entire subarrays in each vertex](/docs/#Algorithms/Data_Structures/Segment_Tree/#saving-the-entire-subarrays-in-each-vertex)).
...
Using this Segment Tree we can find in $O(\log n)$ time the position of the $k$-th element using the same technique discussed in [Counting the number of zeros, searching for the $k$-th zero](/docs/#Algorithms/Data_Structures/Segment_Tree/#counting-zero-search-kth).
